...
Run on AutoDL from the repository root (not on this CPU-only workstation):

```powershell
python tools/run_nupart_stage0.py --train-cache logs/nurank/stage1_tnbc_train/<formal_train_cache> --development-cache logs/nurank/stage1_tnbc_dev/<formal_development_cache> --data-root <TNBC_ROOT> --checkpoint ../CA-SAM2-HRC/deliver_ckpts/tnbc_pms_best_e156.pth --baseline-maps <FORMAL_TOKEN0_ASSEMBLY_NPZ> --out-dir logs/nupart/stage0/<run_id>
```
